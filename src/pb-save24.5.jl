...
function analyse_vary_noise(solving_options, observation, noises, simulating_function, temp_observed_data, start_init, stop_init, start_alpha, stop_alpha,sde_noise)
...
function analyse_vary_observations_and_noise(solving_options, true_alpha, true_init, observations, noises, simulating_function, start_init, stop_init, start_alpha, stop_alpha,sde_noise)
    ...
    logl_varried_noise_and_obs = ([analyse_vary_noise(solving_options, observations[i], noises, simulating_function, temp_observed_data, start_init, stop_init, start_alpha, stop_alpha,sde_noise) for i in 1:length(observations)]...)
end
